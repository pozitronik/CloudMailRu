...
type
	...
	public
		constructor Create(filename: WideString; SplitSize: Int64 = $80000000);
...
function TFileSplitter.CRCend(crc: DWord): DWord;
begin
	CRCend := (crc xor CRCSeed);
end;

constructor TFileSplitter.Create(filename: WideString; SplitSize: Int64);
begin
