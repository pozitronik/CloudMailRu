...
begin
	...
	var Success := FCloud.GetDirListing('/test', DirListing);
...
begin
	...
	var Success := FCloud.CreateDir('/ExistingFolder');
...
begin
	...
	var Success := FCloud.DeleteFile('/nonexistent.txt');
...
begin
	...
	var Result := FCloud.RenameFile('/readonly.txt', 'newname.txt');
