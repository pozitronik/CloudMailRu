...
procedure TCMRFileIdentityTest.TestIsEqualToIdentical;
var
	Identity1, Identity2: TCMRFileIdentity;
begin
...
procedure TCMRFileIdentityTest.TestIsEqualToDifferentHash;
var
	Identity1, Identity2: TCMRFileIdentity;
begin
	Identity1.Hash := 'ABC123DEF456';
...
procedure TCMRFileIdentityTest.TestIsEqualToDifferentSize;
var
	Identity1, Identity2: TCMRFileIdentity;
begin
	Identity1.Hash := 'ABC123DEF456';
...
procedure TCMRFileIdentityTest.TestIsEqualToBothDifferent;
var
	Identity1, Identity2: TCMRFileIdentity;
begin
	Identity1.Hash := 'ABC123DEF456';
...
procedure TCMRFileIdentityTest.TestIsEqualToEmptyStrings;
var
	Identity1, Identity2: TCMRFileIdentity;
begin
	Identity1.Hash := '';
...
procedure TCMRFileIdentityTest.TestIsEqualToZeroSize;
var
	Identity1, Identity2: TCMRFileIdentity;
begin
...
procedure TCMRFileIdentityTest.TestIsEqualToCaseSensitiveHash;
var
	Identity1, Identity2: TCMRFileIdentity;
begin
...
TDUnitX.RegisterTestFixture(TCMRFileIdentityTest);
