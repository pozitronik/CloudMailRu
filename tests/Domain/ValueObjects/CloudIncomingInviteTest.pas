...
type
	...
	[TestFixture]
	TCloudIncomingInviteTest = class
	public
		[Test]
...
procedure TCloudIncomingInviteTest.TestIsNoneWhenEmpty;
var
...
procedure TCloudIncomingInviteTest.TestIsNoneWhenHasName;
var
	Invite: TCloudIncomingInvite;
begin
	FillChar(Invite, SizeOf(Invite), 0);
...
procedure TCloudIncomingInviteTest.TestIsMountedWhenHasHome;
var
	Invite: TCloudIncomingInvite;
begin
	FillChar(Invite, SizeOf(Invite), 0);
...
procedure TCloudIncomingInviteTest.TestIsMountedWhenNoHome;
var
	Invite: TCloudIncomingInvite;
begin
	FillChar(Invite, SizeOf(Invite), 0);
...
procedure TCloudIncomingInviteTest.TestNoneCreatesEmptyRecord;
var
	Invite: TCloudIncomingInvite;
begin
...
procedure TCloudIncomingInviteTest.TestNoneIsNoneTrue;
var
	Invite: TCloudIncomingInvite;
begin
	Invite := TCloudIncomingInvite.None;
...
procedure TCloudIncomingInviteTest.TestRecordWithAllFields;
var
	Invite: TCloudIncomingInvite;
begin
	FillChar(Invite, SizeOf(Invite), 0);
...
TDUnitX.RegisterTestFixture(TCloudIncomingInviteTest);
