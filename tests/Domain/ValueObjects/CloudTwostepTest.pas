...
procedure TCloudTwostepTest.TestFromJSONValid;
var
...
procedure TCloudTwostepTest.TestFromJSONAllFields;
var
	Twostep: TCloudTwostep;
begin
...
procedure TCloudTwostepTest.TestFromJSONTimeoutWithValue;
var
	Twostep: TCloudTwostep;
begin
	TCloudTwostepJsonAdapter.Parse(JSON_TWOSTEP_FULL, Twostep);
...
procedure TCloudTwostepTest.TestFromJSONTimeoutEmpty;
var
	Twostep: TCloudTwostep;
begin
...
procedure TCloudTwostepTest.TestFromJSONTimeoutMissing;
var
	Twostep: TCloudTwostep;
begin
	{ When timeout field is missing, it should remain at default (0) }
	TCloudTwostepJsonAdapter.Parse(JSON_TWOSTEP_NO_TIMEOUT, Twostep);

	{ Default value when field is missing }
	Assert.AreEqual(Int64(0), Twostep.secstep_timeout);
end;

procedure TCloudTwostepTest.TestFromJSONPartialData;
var
	Twostep: TCloudTwostep;
begin
...
procedure TCloudTwostepTest.TestFromJSONInvalidJSON;
var
	Twostep: TCloudTwostep;
begin
	Assert.IsFalse(TCloudTwostepJsonAdapter.Parse('not valid json', Twostep));
end;

procedure TCloudTwostepTest.TestFromJSONEmptyString;
var
	Twostep: TCloudTwostep;
begin
	Assert.IsFalse(TCloudTwostepJsonAdapter.Parse('', Twostep));
end;

initialization

TDUnitX.RegisterTestFixture(TCloudTwostepTest);
