unit CMRDirItemJsonAdapterTest;
...
type
	[TestFixture]
	TCMRDirItemJsonAdapterTest = class
	private
		const
...
procedure TCMRDirItemJsonAdapterTest.TestParse_FileItem_ReturnsTrue;
var
	Item: TCMRDirItem;
begin
	Assert.IsTrue(TCMRDirItemJsonAdapter.Parse(JSON_FILE_ITEM, Item));
end;

procedure TCMRDirItemJsonAdapterTest.TestParse_FileItem_ParsesAllFields;
var
	Item: TCMRDirItem;
begin
	TCMRDirItemJsonAdapter.Parse(JSON_FILE_ITEM, Item);
...
procedure TCMRDirItemJsonAdapterTest.TestParse_FolderItem_ReturnsTrue;
var
	Item: TCMRDirItem;
begin
	Assert.IsTrue(TCMRDirItemJsonAdapter.Parse(JSON_FOLDER_ITEM, Item));
end;

procedure TCMRDirItemJsonAdapterTest.TestParse_FolderItem_ParsesAllFields;
var
	Item: TCMRDirItem;
begin
	TCMRDirItemJsonAdapter.Parse(JSON_FOLDER_ITEM, Item);
...
procedure TCMRDirItemJsonAdapterTest.TestParse_FolderItem_ParsesCount;
var
	Item: TCMRDirItem;
begin
	TCMRDirItemJsonAdapter.Parse(JSON_FOLDER_ITEM, Item);
...
procedure TCMRDirItemJsonAdapterTest.TestParse_InvalidJSON_ReturnsFalse;
var
	Item: TCMRDirItem;
begin
	Assert.IsFalse(TCMRDirItemJsonAdapter.Parse(JSON_INVALID, Item));
end;

procedure TCMRDirItemJsonAdapterTest.TestParse_EmptyJSON_ReturnsFalse;
var
	Item: TCMRDirItem;
begin
	Assert.IsFalse(TCMRDirItemJsonAdapter.Parse(JSON_EMPTY, Item));
end;

procedure TCMRDirItemJsonAdapterTest.TestParse_FileItem_IsFileTrue;
var
	Item: TCMRDirItem;
begin
	TCMRDirItemJsonAdapter.Parse(JSON_FILE_ITEM, Item);
...
procedure TCMRDirItemJsonAdapterTest.TestParse_FolderItem_IsDirTrue;
var
	Item: TCMRDirItem;
begin
	TCMRDirItemJsonAdapter.Parse(JSON_FOLDER_ITEM, Item);
...
TDUnitX.RegisterTestFixture(TCMRDirItemJsonAdapterTest);
