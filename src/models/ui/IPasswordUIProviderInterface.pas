unit IPasswordUIProviderInterface;
...
function TNullPasswordUIProvider.AskPassword(Title, Text: WideString;
...
function TNullPasswordUIProvider.AskAction(Title, Text: WideString;
	ActionsList: TDictionary<Int32, WideString>; ParentWindow: HWND): Integer;
begin
	Result := mrCancel;
end;
