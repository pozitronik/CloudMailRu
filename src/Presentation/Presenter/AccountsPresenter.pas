...
begin
	...
	try
		...
		FView.SetHideDescriptionFile(Settings.HideDescriptionFile);
		FView.SetSkipDescriptionDownload(Settings.SkipDescriptionDownload);
		...
		FView.SetHideTimestampFile(Settings.HideTimestampFile);
		FView.SetSkipTimestampDownload(Settings.SkipTimestampDownload);
...
begin
	...
	Settings.HideDescriptionFile := FView.GetHideDescriptionFile;
	Settings.SkipDescriptionDownload := FView.GetSkipDescriptionDownload;
	...
	Settings.HideTimestampFile := FView.GetHideTimestampFile;
	Settings.SkipTimestampDownload := FView.GetSkipTimestampDownload;
