...
var
	...
	ASK_SAVE_SERVER_CHANGES: WideString;
	...
	VKID_AUTH_COOKIE_NIL: WideString;
	VKID_SESSION_RESTORED: WideString;
	VKID_COOKIES_EXPIRED: WideString;
	VKID_LOGIN_FORM_FAILED: WideString;
	VKID_LOGIN_DETAILS: WideString;
	VKID_COOKIE_DETAIL: WideString;
	VKID_CSRF_EMPTY: WideString;
	VKID_COOKIES_SAVED: WideString;
	...
	DFM_LBL_THUMBNAIL_URL: WideString;
	...
	DFM_COL_SERVER_NAME: WideString;
	DFM_COL_SERVER_URL: WideString;
...
begin
	...
	ASK_SAVE_SERVER_CHANGES := 'Save changes to server profile "%s"?';
	...
	VKID_AUTH_COOKIE_NIL := 'VK ID: AuthCookie is nil';
	VKID_SESSION_RESTORED := 'VK ID: Restored session from cookies, CSRF refreshed';
	VKID_COOKIES_EXPIRED := 'VK ID: Saved cookies expired, showing login form';
	VKID_LOGIN_FORM_FAILED := 'VK ID: Login form returned False (script: %s)';
	VKID_LOGIN_DETAILS := 'VK ID: Cookies=%d, CSRF length=%d, script=%s';
	VKID_COOKIE_DETAIL := 'VK ID: Cookie[%d] name=%s domain=%s path=%s';
	VKID_CSRF_EMPTY := 'VK ID: CSRF token is empty, script result: %s';
	VKID_COOKIES_SAVED := 'VK ID: Cookies saved to %s';
	...
	DFM_LBL_THUMBNAIL_URL := 'Thumbnail URL';
	...
	DFM_COL_SERVER_NAME := 'Name';
	DFM_COL_SERVER_URL := 'URL';
	...
	DFM_CB_DESC_ENABLED := 'Read comments from cloud filesystem';
	DFM_CB_DESC_EDITOR := 'Enable comments editor';
	DFM_CB_DESC_COPY_TO := 'Copy comments to cloud';
	DFM_CB_DESC_COPY_FROM := 'Copy comments from cloud';
	DFM_CB_DESC_TRACK := 'Track cloud filesystem changes';
	DFM_CB_HIDE_DESC_FILE := 'Hide comments file in directory listing';
	DFM_CB_SKIP_DESC_DOWNLOAD := 'Skip comments file when downloading';
	DFM_GB_FILE_COMMENTS := 'File comments';
	DFM_GB_FILE_TIMESTAMPS := 'File timestamps';
	DFM_OPT_TS_DISABLED := 'Disabled';
	DFM_OPT_TS_CLOUD_TIME := 'Set cloud time on download';
	DFM_OPT_TS_FULL_SYNC := 'Preserve local time (upload & download)';
...
begin
	...
	TranslationRegistry.Add('ASK_SAVE_SERVER_CHANGES', @ASK_SAVE_SERVER_CHANGES);
	...
	TranslationRegistry.Add('VKID_AUTH_COOKIE_NIL', @VKID_AUTH_COOKIE_NIL);
	TranslationRegistry.Add('VKID_SESSION_RESTORED', @VKID_SESSION_RESTORED);
	TranslationRegistry.Add('VKID_COOKIES_EXPIRED', @VKID_COOKIES_EXPIRED);
	TranslationRegistry.Add('VKID_LOGIN_FORM_FAILED', @VKID_LOGIN_FORM_FAILED);
	TranslationRegistry.Add('VKID_LOGIN_DETAILS', @VKID_LOGIN_DETAILS);
	TranslationRegistry.Add('VKID_COOKIE_DETAIL', @VKID_COOKIE_DETAIL);
	TranslationRegistry.Add('VKID_CSRF_EMPTY', @VKID_CSRF_EMPTY);
	TranslationRegistry.Add('VKID_COOKIES_SAVED', @VKID_COOKIES_SAVED);
	...
	TranslationRegistry.Add('DFM_LBL_THUMBNAIL_URL', @DFM_LBL_THUMBNAIL_URL);
	...
	TranslationRegistry.Add('DFM_COL_SERVER_NAME', @DFM_COL_SERVER_NAME);
	TranslationRegistry.Add('DFM_COL_SERVER_URL', @DFM_COL_SERVER_URL);
