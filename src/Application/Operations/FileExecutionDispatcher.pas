...
type
	...
	TExecutionActionType = (eatNone, {No action required, return FS_EXEC_OK}
	...
	IFileExecutionDispatcher = interface
		...
		function GetAction(const RemoteName, Verb: WideString; StreamingGetter: TStreamingSettingsGetter): TExecutionAction;
	end;
...
function TFileExecutionDispatcher.GetAction(const RemoteName, Verb: WideString; StreamingGetter: TStreamingSettingsGetter): TExecutionAction;
var
	RealPath: TRealPath;
