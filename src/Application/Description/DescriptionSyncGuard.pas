...
type
	...
	public
		...
		constructor Create(SyncManager: IDescriptionSyncManager; SettingsManager: IPluginSettingsManager; AccountsManager: IAccountsManager);
...
constructor TDescriptionSyncGuard.Create(SyncManager: IDescriptionSyncManager; SettingsManager: IPluginSettingsManager; AccountsManager: IAccountsManager);
begin
	inherited Create;
...
begin
	Result := FSettingsManager.GetSettings.DescriptionTrackCloudFS and FAccountsManager.GetAccountSettings(Account).IsRemoteDescriptionsSupported;
end;

function TDescriptionSyncGuard.IsUploadEnabled(const Account: WideString): Boolean;
begin
	Result := FSettingsManager.GetSettings.DescriptionCopyToCloud and FAccountsManager.GetAccountSettings(Account).IsRemoteDescriptionsSupported;
end;
