...
begin
	...
	ConnectionManager := TConnectionManager.Create(SettingsManager, AccountSettings, HTTPMgr, PasswordUI, CipherVal, TWindowsFileSystem.Create, Progress, Logger, Request, PasswordManager, FTCHandler, TDefaultAuthStrategyFactory.Create, FOpenSSLProvider, TAccountCredentialsProvider.Create(PasswordManager, PasswordUI, Logger, FTCHandler, AccountSettings), TServerProfileManager.Create(TIniConfigFile.Create(SettingsManager.IniFilePath)));
