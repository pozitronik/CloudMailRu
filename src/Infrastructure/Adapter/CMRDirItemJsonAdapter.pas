unit CMRDirItemJsonAdapter;

{Infrastructure adapter for parsing JSON responses into TCMRDirItem.
...
type
	TCMRDirItemJsonAdapter = class
	public
		{Parses JSON response into TCMRDirItem record.
		...
		class function Parse(const JSON: WideString; out Item: TCMRDirItem): Boolean; static;
	end;
...
class function TCMRDirItemJsonAdapter.Parse(const JSON: WideString; out Item: TCMRDirItem): Boolean;
var
