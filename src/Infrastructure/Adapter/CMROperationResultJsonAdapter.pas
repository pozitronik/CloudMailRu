unit CMROperationResultJsonAdapter;

{Adapter to parse JSON into TCMROperationResult records.
...
type
	TCMROperationResultJsonAdapter = class
	public
		class procedure Parse(const JSON: WideString; out OperationResult: TCMROperationResult); static;
		class function ParseRegistration(const JSON: WideString; out OperationResult: TCMROperationResult): Boolean; static;
	end;
...
class procedure TCMROperationResultJsonAdapter.Parse(const JSON: WideString; out OperationResult: TCMROperationResult);
var
	JSONVal: TJSONObject;
...
class function TCMROperationResultJsonAdapter.ParseRegistration(const JSON: WideString; out OperationResult: TCMROperationResult): Boolean;
var
	JSONVal: TJSONObject;
begin
	Result := False;
