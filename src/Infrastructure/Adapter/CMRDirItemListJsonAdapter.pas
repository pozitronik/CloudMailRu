unit CMRDirItemListJsonAdapter;

{Infrastructure adapter for parsing JSON responses into TCMRDirItemList.
...
type
	TCMRDirItemListJsonAdapter = class
	public
		{Parses JSON response into TCMRDirItemList array.
		...
		class function Parse(const JSON: WideString; var List: TCMRDirItemList): Boolean; static;
	end;
...
class function TCMRDirItemListJsonAdapter.Parse(const JSON: WideString; var List: TCMRDirItemList): Boolean;
var
	J: Integer;
	A: TJSONArray;
	JSONVal: TJSONObject;
