unit CMRTwostepJsonAdapter;

{Adapter to parse JSON into TCMRTwostep records.
...
type
	TCMRTwostepJsonAdapter = class
	public
		class function Parse(const JSON: WideString; out Twostep: TCMRTwostep): Boolean; static;
	end;
...
class function TCMRTwostepJsonAdapter.Parse(const JSON: WideString; out Twostep: TCMRTwostep): Boolean;
var
