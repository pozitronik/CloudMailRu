unit CMRIncomingInviteListJsonAdapter;

{Adapter to parse JSON into TCMRIncomingInviteList arrays.
...
type
	TCMRIncomingInviteListJsonAdapter = class
	public
		class function Parse(const JSON: WideString; var List: TCMRIncomingInviteList): Boolean; static;
	end;
...
class function TCMRIncomingInviteListJsonAdapter.Parse(const JSON: WideString; var List: TCMRIncomingInviteList): Boolean;
var
	JSONVal: TJSONObject;
