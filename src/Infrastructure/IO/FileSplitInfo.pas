...
var
	CRCValue: DWord;
	inbuffer: array [1 .. CRC32_BUFFER_SIZE] of Byte;
	ReadBytes: Integer;
...
begin
	DataStream.WriteString(Format('filename=%s%ssize=%d%scrc32=%s', [ExtractFileName(self.filename), sLineBreak, self.FFileSize, sLineBreak, self.GetCRC32File]));
end;
