...
{$ENDIF}
	...
	ANSIFunctions in 'src\types\ANSIFunctions.pas',
	...
	TCLogger in 'src\models\TCLogger.pas',
	TCPasswordManager in 'src\models\TCPasswordManager.pas',
	TCProgress in 'src\models\TCProgress.pas',
	TCRequest in 'src\models\TCRequest.pas',
	Variants,
	Vcl.Controls,
